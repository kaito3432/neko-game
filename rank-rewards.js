...
(function(root){
  ...
  const ranks=Object.freeze([
    Object.freeze({id:'bronze',name:'ブロンズ',min:0,max:99,icon:'🥉',seasonCoins:0,frameId:null,arrivalRewards:[]}),
    Object.freeze({id:'silver',name:'シルバー',min:100,max:249,icon:'🐾',seasonCoins:200,frameId:'rank_silver',arrivalRewards:['シルバーフレーム']}),
    Object.freeze({id:'gold',name:'ゴールド',min:250,max:449,icon:'✨',seasonCoins:400,frameId:'rank_gold',arrivalRewards:['ゴールドフレーム']}),
    Object.freeze({id:'platinum',name:'プラチナ',min:450,max:699,icon:'🌙',seasonCoins:700,frameId:'rank_platinum',arrivalRewards:['プラチナフレーム']}),
    Object.freeze({id:'diamond',name:'ダイヤ',min:700,max:999,icon:'💎',seasonCoins:1100,frameId:'rank_diamond',arrivalRewards:['ダイヤフレーム']}),
    Object.freeze({id:'master',name:'マスター',min:1000,max:null,icon:'👑',seasonCoins:1500,frameId:'rank_master',arrivalRewards:['マスターフレーム','マスター限定スキン']})
  ]);
  ...
  function card(item){
    ...
    const frame=item.frameId
      ?`<span class="rank-reward-frame ranked-frame-preview" data-frame-id="${item.frameId}" aria-hidden="true">🐾</span>`
